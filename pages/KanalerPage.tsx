    ...
    <>
      <section className="bg-slate-950 pt-32 pb-20 relative overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <span className="text-red-400 text-xs font-bold tracking-widest uppercase mb-4 block">LIVE TV</span>
          <h2 className="text-3xl md:text-5xl font-extrabold mb-12">Alle deine Lieblingssender</h2>
          <ChannelScroller />
